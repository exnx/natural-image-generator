...
def get_margin_color(background_color, min_margin):

    top = 100  # top range of margin
...
def random_font_color(background_color):
    ...
    while not margin_met:
        ...
        r = get_margin_color(background_color[0], margin_min)
        g = get_margin_color(background_color[1], margin_min)
        b = get_margin_color(background_color[2], margin_min)
